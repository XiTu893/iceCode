...
export function REPL({
  ...
  const terminalTitle = sessionTitle ?? agentTitle ?? haikuTitle ?? 'IceCode';
  ...
  // That write storm is the primary trigger for ~/.IceCode.json corruption
  // (GH #3117).
  ...
  useEffect(() => {
    const handleSuspend = () => {
      ...
      process.stdout.write(`\nIceCode has been suspended. Run \`fg\` to bring IceCode back.\nNote: ctrl + z now suspends IceCode, ctrl + _ undoes input.\n`);
    };
    const handleResume = () => {
