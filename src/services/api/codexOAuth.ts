...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to IceCode now.</p>
    <p>IceCode will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in IceCode.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in IceCode.</p>
  </body>
</html>`
}
