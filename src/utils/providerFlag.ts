 ...
 *
 * Usage:
 *   IceCode --provider openai --model gpt-4o
 *   IceCode --provider gemini --model gemini-2.0-flash
 *   IceCode --provider mistral --model ministral-3b-latest
 *   IceCode --provider ollama --model llama3.2
 *   IceCode --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `IceCode --model <name>` should work standalone so users can
