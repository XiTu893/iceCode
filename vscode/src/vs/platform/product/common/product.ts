...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.121.0-dev',
			nameShort: 'IceCode Dev',
			nameLong: 'IceCode IDE Dev',
			applicationName: 'icecode',
			dataFolderName: '.icecode',
			urlProtocol: 'icecode',
			reportIssueUrl: 'https://github.com/icecode-ide/icecode/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/icecode-ide/icecode/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/icecode-ide/icecode/blob/main/LICENSE.txt'
		});
	}
}
