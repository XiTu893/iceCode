# Contributing to IceCode

Thanks for contributing.

IceCode is a fast-moving open-source AI coding agent CLI with desktop IDE integration. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/XiTu893/iceIDE/issues) and [discussions](https://github.com/XiTu893/iceIDE/discussions) before opening a new thread.
...
IceCode supports multiple provider paths. If you change provider logic:
